  ...
  return (
    <header className="h-[100px] bg-blue-600 text-white flex flex-col justify-center fixed top-0 left-0 right-0">
      <ul className="flex justify-around items-center">
        <li>
          <NavLink to={"home"} className={({isActive}) => isActive ? "text-green-200" : "text-white"} end>
            <button className="py-1 px-4 bg-blue-500 rounded-lg">Home</button>
          </NavLink>
        </li>
        <li>
          <NavLink to={"products"} className={({isActive}) => isActive ? "text-green-200" : "text-white"} end>
